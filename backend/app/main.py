...
from app.knowledge_bases.routes import knowledge_base_router
...
app.include_router(
    thread_router,
    prefix=f"{version_prefix}/threads",
    tags=["THREADS"],
)
...
app.include_router(
    document_router,
    prefix=f"{version_prefix}/documents",
    tags=["DOCUMENTS"],
)

app.include_router(
    knowledge_base_router,
    prefix=f"{version_prefix}/knowledge-bases",
